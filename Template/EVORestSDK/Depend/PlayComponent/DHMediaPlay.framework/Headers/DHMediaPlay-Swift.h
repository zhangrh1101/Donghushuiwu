...
SWIFT_CLASS("_TtC11DHMediaPlay13CloudBaseTalk")
@interface CloudBaseTalk : Camera
...
@property (nonatomic) NSInteger talkType;
@property (nonatomic) NSInteger transMode;
...
- (void)onWindowSelectedWithPosition:(NSUInteger)position;
/// 窗口页面变化的回调
...
@property (nonatomic) BOOL isUseTls;
/// 新增authorization字段用于达尔文平台
@property (nonatomic, copy) NSString * _Nonnull authorization;
/// 是否是云基线版本，【可选】默认false
@property (nonatomic) BOOL bCloudBase;
/// 是否是EVO达尔文版本，【可选】默认false
@property (nonatomic) BOOL bEVOBase;
