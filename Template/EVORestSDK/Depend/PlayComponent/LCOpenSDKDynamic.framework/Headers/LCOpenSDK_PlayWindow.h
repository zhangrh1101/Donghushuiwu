 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playRtspReal:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn definition:(NSInteger)defiMode optimize:(BOOL)isOpt isTls:(BOOL)isTls;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playRtspReal:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channelEx:(NSString* )channelEx definition:(NSInteger)defiMode optimize:(BOOL)isOpt isTls:(BOOL)isTls;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playRtspReal:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn channelEx:(NSString* )channelEx definition:(NSInteger)defiMode optimize:(BOOL)isOpt isTls:(BOOL)isTls;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playDeviceRecord:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn fileName:(NSString*)fileName begin:(long)beginTime end:(long)endTime offsetTime:(double)offsetTime optimize:(BOOL)isOpt isTls:(BOOL)isTls;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playDeviceRecord:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channelEx:(NSString* )channelEx fileName:(NSString*)fileName begin:(long)beginTime end:(long)endTime offsetTime:(double)offsetTime optimize:(BOOL)isOpt isTls:(BOOL)isTls;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playDeviceRecord:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn channelEx:(NSString* )channelEx fileName:(NSString*)fileName begin:(long)beginTime end:(long)endTime offsetTime:(double)offsetTime optimize:(BOOL)isOpt isTls:(BOOL)isTls;

- (NSInteger) playDeviceRecordByFileName:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk fileName:(NSString*)fileName offsetTime:(double)offsetTime channel:(NSInteger)chn optimize:(BOOL)isOpt isTls:(BOOL)isTls;

- (NSInteger) playDeviceRecordByUtcTime:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn begin:(long)beginTime end:(long)endTime optimize:(BOOL)isOpt isTls:(BOOL)isTls;

- (NSInteger) playDeviceRecordByUtcTime:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channelEx:(NSString* )channelEx begin:(long)beginTime end:(long)endTime optimize:(BOOL)isOpt isTls:(BOOL)isTls;

- (NSInteger) playDeviceRecordByUtcTime:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn channelEx:(NSString* )channelEx begin:(long)beginTime end:(long)endTime optimize:(BOOL)isOpt isTls:(BOOL)isTls;
...
/**
 * 某类IVS智能数据使能子开关
 * @param ivsType 枚举值定义见LCOpenSDK_Define.h中的OC_IVS_TYPE
 * @param enable 1: 开启；0: 关闭
 * @return -1失败, 0成功
 */
 ...
 * @param
 */
- (NSInteger)setOSDInfo:(LCOpenSDK_OsdInfo *)osdInfo;
