 ...
 *                        －1, 失败
 */
- (NSInteger) playTalk:(NSString*)accessTok devID:(NSString*)deviceID channelId:(NSInteger)chn psk:(NSString*)psk optimize:(BOOL)isOpt isTls:(BOOL)isTls;
 ...
 *                        －1, 失败
 */
- (NSInteger) playTalk:(NSString*)accessTok devID:(NSString*)deviceID channelIdEx:(NSString*)chn psk:(NSString*)psk optimize:(BOOL)isOpt isTls:(BOOL)isTls;
