...
@property (nonatomic, copy, nullable)NSString *contactTime;      ///< 时间
@property (nonatomic, copy, nullable)NSString *contactName;      ///< 联系人名字
@property (nonatomic, copy, nullable)NSString *contactNum;       ///< 联系人号码
...
@property (nonatomic, copy, nullable) NSString *durationStr;       ///< 通话时长字符串
@property (nonatomic, copy, nullable) NSString *callTypeStr; ///<呼叫类型 (0-呼入,1-呼出)
@property (nonatomic, copy, nullable) NSString *endStateStr; ///<呼叫状态 (0-未接,1-已接)
@end
