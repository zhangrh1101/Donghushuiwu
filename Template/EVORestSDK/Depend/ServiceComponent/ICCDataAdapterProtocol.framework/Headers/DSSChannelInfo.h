...
typedef enum : NSUInteger {
    ...
    MBL_CHNL_RIGHT_MONITOR                = 0x00000001,        ///< 实时预览 monitor
    ...
    MBL_CHNL_RIGHT_SD_IDLEACT            = 0x00400000,      ///< 音频权限
    ...
    MBL_CHNL_RIGHT_CUSTOM_SOUND = 0x08000000, ///< 声报警
    MBL_CHNL_RIGHT_CUSTOM_LIGHT = 0x10000000, ///< 光报警
...
typedef enum:NSUInteger {
    ...
    MBL_CHANNEL_CAPABILITY_ELECTRIC_FOCUS           =  0x00000004,              ///< 电动聚焦
    MBL_CHANNEL_CAPABILITY_THERMAL_IMAGING          =  0x00000008,              ///< 热成像
    MBL_CHANNEL_CAPABILITY_HEATMAPS_STATISTICS      =  0x00000010,              ///< 热度图统计
    MBL_CHANNEL_CAPABILITY_GUOXIAN                  =  0x00000020,              ///< 过线人数统计
    MBL_CHANNEL_CAPABILITY_PEOPLE_STATISTICS        =  0x00000040,              ///< 区域人数统计
    MBL_CHANNEL_CAPABILITY_FACE_DETECTION           =  0x00000080,              ///< 人脸检测
    MBL_CHANNEL_CAPABILITY_FACE_RECOGNITION         =  0x00000100,              ///< face识别
    MBL_CHANNEL_CAPABILITY_OBJECT_CAPTURE           =  0x00000200,              ///< 目标抓拍
    MBL_CHANNEL_CAPABILITY_MAIN_SUB_TRACKING    =  0x00000400,              ///< 主从跟踪
    MBL_CHANNEL_CAPABILITY_ENTRANCE_CAPTURE         =  0x00000800,              ///< 出入口抓拍
    MBL_CHANNEL_CAPABILITY_AR                       =  0x00001000,              ///< AR
    MBL_CHANNEL_CAPABILITY_PEOPLE_STATISTICS_FISH   =  0x00002000,              ///< 多区域人数统计 ------ 用于AI鱼眼
    MBL_CHANNEL_CAPABILITY_THUNDERBALL_LINKAGE      =  0x00004000,              ///< 雷球联动
    MBL_CHANNEL_CAPABILITY_BEHAVIOR_ANALYSIS        =  0x00008000,              ///< 行为分析
    MBL_CHANNEL_CAPABILITY_PASSANGER_FLOW           =  0x00010000,              ///< 客流
...
@property (nonatomic, assign) MBL_FACE_TYPE faceFunctionType;///<face识别能力类型 unit type
...
/// 通道子类型 sub type
typedef enum:NSUInteger {
    MBL_CHANNEL_SUB_TYPE_COMMON = 0, ///< 0-普通视频
    MBL_CHANNEL_SUB_TYPE_VISIBLE, ///< 1-可见光
    MBL_CHANNEL_SUB_TYPE_THERMAL,///< 2-热成像
}MBL_CHANNEL_SUB_TYPE;
...
@property (nonatomic, assign) MBL_CHANNEL_SUB_TYPE channelSubType;///通道子类型,视频通道[0=普通视频1-可见光2-热成像]
@property (nonatomic, copy ,nullable) NSString* cameraFunctions;  //通道能力集
@property (nonatomic, assign) int iTrackID;                        // 取流类型

@property (nonatomic, strong) NSMutableArray* _Nullable arrPtzPrePointInfo;
...
@property (nonatomic, assign) BOOL selected; ///<code
